...
#dataset = read_data('D:\ME\ME_2nd_Year\ADM\project\har\Dataset\WISDM_ar_v1.1_raw.txt')

dataset = pd.read_csv(r'D:\ME\ME_2nd_Year\ADM\project\har\Dataset\colab_dataset_mobile.csv')
