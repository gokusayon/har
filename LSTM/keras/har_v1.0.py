...
# =============================================================================
# np.save("dumps/segments", segments)
# np.save("dumps/labels", labels)
#
...
reshapedSegments = segments.reshape(segments.shape[0], numOfRows, numOfColumns)
...
print('shape of segments =', trainX.shape)
...
# =============================================================================
    ...
    model.add(LSTM(10, return_sequences=True,input_shape=(numOfRows, 3))) 
...
history = model.fit(trainX,trainY, validation_split=1-trainSplitRatio,epochs=Epochs,batch_size=batchSize,verbose=1,
